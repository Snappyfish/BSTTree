...
int main() {
	...
	Matrix<intPair> m_intp;
	m_intp.set_element(0, 1, intPair(7, 4));
	cout << "element at 0,1 is " << m_intp.get_element(0, 1).getX() << "," << m_intp.get_element(0, 1).getY() << "\n";
