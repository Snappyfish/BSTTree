...
int main() {
	/*
	BinarySearchTree coolTree;
	BinarySearchTree anotherCoolTree;

	//coolTree.insertInteger(5);
	anotherCoolTree.insertInteger(1);

	anotherCoolTree.printTree();
	coolTree.asdf(&anotherCoolTree);
	anotherCoolTree.printTree();
	*/

	BinarySearchTreeTemplate<int> coolTree;
